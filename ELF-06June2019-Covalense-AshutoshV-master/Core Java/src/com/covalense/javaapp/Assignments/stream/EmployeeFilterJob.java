...
@Log
public class EmployeeFilterJob {
	public static void main(String[] args) {
		...
		Predicate<Employee> p = (i) -> i.experience > 2 && i.jobType == "Software Engineer";

		List<Employee> l = al.stream().filter(p).collect(Collectors.toList());
		log.info("" + l);
	}
