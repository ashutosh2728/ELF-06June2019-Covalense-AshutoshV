...
public class LoginServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (request.getCookies() == null) {
			request.getRequestDispatcher("EMP/cookiesDisabled.html").include(request, response);
			return;
		}
		...
		if (bean.getPassword().equals(passwordValue) && bean.getId() == Integer.parseInt(idValue)) {
			...
			out.print("<div>");
			out.print(
					" <a href = \" ./profile\"> <img src=\"https://cdn.pixabay.com/photo/2019/07/15/12/02/portrait-4339180__340.jpg\" alt=\"\" width=\"150\" height=\"150\">   ");
			out.print("</a>");
